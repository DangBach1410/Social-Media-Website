<form id="editCommentForm" action="edit_comment.php?id=<?php echo htmlspecialchars($_GET['id']) ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="comment-header">
        ...
        <div id="content-contain">
            <textarea id="content" name="content" placeholder="Comment..." required><?php echo htmlspecialchars($comment['content']); ?></textarea><br>
